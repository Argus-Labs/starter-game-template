...
func PlayerSpawnerSystem(world *cardinal.World, tq *cardinal.TransactionQueue, _ *cardinal.Logger) error {
	...
	for _, create := range createTxs {
		...
		tx.CreatePlayer.SetResult(world, create.Hash(), tx.CreatePlayerMsgReply{true})
	}
